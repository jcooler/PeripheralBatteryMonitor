...
| Apex Pro TKL Wireless | Close the GG device page after a fresh event and leave it closed until the reading ages to last-known. | The key changes to `~percentage` without reopening GG; record the transition time and value. |  |  |  |
| Arctis Nova Pro Wireless | Close the GG device page after a fresh event and leave it closed until the reading ages to last-known. | The key changes to `~percentage` without reopening GG; record the transition time and value. |  |  |  |
...
| Apex Pro TKL Wireless | Turn the device off, wait for a confirmed disconnect, then turn it on without opening its GG page. | Disconnect clears the cached reading. After power-on, the display remains honestly unavailable until a new device battery event arrives. |  |  |  |
| Arctis Nova Pro Wireless | Turn the device off, wait for a confirmed disconnect, then turn it on without opening its GG page. | Disconnect clears the cached reading. After power-on, the display remains honestly unavailable until a new device battery event arrives. |  |  |  |
